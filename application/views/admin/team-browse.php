  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>Browse<small>Post Holders</small></h1>
            <!-- <ol class="breadcrumb">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th bgcolor="#222D32" style="color: white">Post</th>
                            <th bgcolor="#222D32" style="color: white">Phone</th>
                            <th bgcolor="#222D32" style="color: white">Fb Id</th>
                          </tr>
                        ...
                        <form id="team-list" method="post">
                            ...
                            <tr class="more-options">
                                <td></td>
                                <td><?php echo $team['post_holder_name']?></td>
                                <td><?php echo $team['post_holder_post'] ?></td>
                                <td><?php echo $team['post_holder_phone'] ?></td>
                                <td><?php echo $team['post_holder_fb'] ?></td>
                            </tr>
                            <tr class="hidden list-more-options" id="show-edit">
                              ...
                              <td colspan="2"><center><a href="javascript:void(0);" onclick="deleteConfirm(<?php echo $team['post_holder_id']; ?>);">Delete</a></center></td>
...
<script type="text/javascript">
    ...
    function deleteConfirm(id){
       var value = confirm("Do you want to delete this?")
        if ( value == true )
          window.location = url+"team/delete/"+id;
        else
          return false;
        } 
</script>
