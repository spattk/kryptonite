  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>Browse<small>People Speak</small></h1>
            <!-- <ol class="breadcrumb">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th bgcolor="#222D32" style="color: white">Designation</th>
                            <th bgcolor="#222D32" style="color: white">Speech</th>
                          </tr>
                        ...
                        <form id="team-list" method="post">
                                ...
                                echo 
                                 '<div class="form-group" class="col-md-12" class="btn btn-success" style="background-color:green;padding:10px;color:white" id="delete-success">' ?>
                                                ...
                                                '<div class="form-group" class="col-md-12" class="btn btn-default" style="background-color:blue;padding: 10px;color: white" id="untrash-success">' ?>
                                                   ...
                                                   <a href="<?php echo SITE_ROOT . 'people/trash' ?>" style="color: red; font-weight: bold" target="_blank">Untrash</a>
                                                <?php echo '</div>'; 
                                             }  
                            ?>
                            ...
                            <tr class="more-options">
                                ...
                                <td><?php echo $people['people_desg'] ?></td>
                                <td><?php echo $people['people_speech'] ?></td>
                            </tr>
                            <tr class="hidden list-more-options" id="show-edit">
                              
                              <td></td>
                              <td colspan="2"><center><a href="<?php echo SITE_ROOT . 'people/edit/' . $people['people_id'] ?>" target="_blank">Edit </a></center></td>
                               <td colspan="2"><center><a href="javascript:void(0);" onclick="deleteConfirm(<?php echo $people['people_id']; ?>);">Delete</a></center></td>
...
<script type="text/javascript">
            ...
            var listItem = $( 'ul.sidebar-menu' ).find( 'li span:contains("People")' ).parent().parent();
...
<script type="text/javascript">
    ...
    function deleteConfirm(id){
       var value = confirm("Do you want to delete this?")
        if ( value == true )
          window.location = url+"people/delete/"+id;
        else
          return false;
        } 
</script>
