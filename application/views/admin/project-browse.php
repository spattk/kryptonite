                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th width="150px" bgcolor="gray">Title</th>
                            <th width="100px" bgcolor="red">Desc</th>
                            <th width="100px" bgcolor="green">Gallery Link</th>
                          </tr>
                        ...
                        <form id="project-list" method="post">
                            ...
                            <tr class="hidden list-more-options" id="show-edit">
                              ...
                              <td><center><a href="">Delete <?php echo $project['project_id'] ?></a></center></td>
